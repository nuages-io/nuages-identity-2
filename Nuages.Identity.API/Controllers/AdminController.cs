...
public class AdminController : Controller
{
    ...
    public AdminController(IChangePasswordService changePasswordService,
    ...
    public async Task<ChangePasswordResultModel> AdminSetPasswordAsync(string userId,
        [FromBody] ChangePasswordModel model)
    {
        try
        {
            ...
            return await _changePasswordService.AdminChangePasswordAsync(userId, model.NewPassword,
                model.NewPasswordConfirm, model.MustChangePassword, model.SendByEmail, null);
        }
        catch (Exception e)
        {
            AWSXRayRecorder.Instance.AddException(e);
